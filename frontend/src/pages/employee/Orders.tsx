...
import { Search, ChevronDown, ChevronUp, Package, MapPin, Truck, Hash, Send } from 'lucide-react';
      ...
      <Card>
        <div className="orders-table">
          <div className="orders-header">
            <div className="header-cell" style={{ width: '5%' }}>ID</div>
            <div className="header-cell" style={{ width: '20%' }}>Order Number</div>
            <div className="header-cell" style={{ width: '20%' }}>Warehouse</div>
            <div className="header-cell" style={{ width: '12%' }}>Status</div>
            <div className="header-cell" style={{ width: '15%' }}>Created</div>
            <div className="header-cell" style={{ width: '20%' }}>Send to ship</div>
            <div className="header-cell" style={{ width: '8%' }}></div>
          </div>
          ...
          {paginatedOrders.map((order) => (
            <React.Fragment key={order.id}>
              ...
              >
                <div className="row-cell" style={{ width: '5%' }}>#{order.id}</div>
                <div className="row-cell" style={{ width: '20%' }}>
                ...
                <div className="row-cell" style={{ width: '12%' }}>
                ...
                <div className="row-cell expand-icon" style={{ width: '8%' }}>
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          if (confirmDialog.orderId) {
            handleShipOrder(confirmDialog.orderId);
          }
        }}
        title="Confirm Shipment"
        message="Are you sure you want to mark this order as shipped? This action cannot be undone."
